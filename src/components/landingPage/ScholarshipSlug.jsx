...
import { GetScholarshipListBySlug, GetScholarshipListService, useAuthCompany } from '../../services/AppServices'
...
function ScholarShipSlug() {
    ...
    useEffect(() => {
        setLoading(true);
        GetScholarshipListBySlug(slug).then((res) => {
    ...
    const shareOnWhatsApp = () => {
        let url = `https://quadnut.org/scholarship/${slug}`
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-md-8 p-md-4 d-flex flex-column align-items-md-start justify-content-md-start align-items-center justify-content-center">
                                            <div>
                                                <h1 className='fw-bold text-center text-md-start'>{scholarshipData?.scholarshipName}</h1>
                                                <h4 className='text-white text-center text-md-start'>{scholarshipData?.scholarshipShortDescription}</h4>
                                            </div>
                                            ...
                                            </div>
                                            {
                                                scholarshipData?.scholarshipType == "OFFLINE" ?
                                                    ...
                                                    <a target='_blank' href={`http://quadnut.org/mock-details/${scholarshipData?.mockTestSlug}`} >
                                    ...
                                    <div className="col-md-6">
                                        <div className="card border-0 exm-time-box" >
                                            <div className='w-100 d-flex align-items-center gap-4 p-lg-5 p-3'>
                                                ...
                                                <div>
                                                    <h4>Exam Dates</h4>
                                                    <p> {scholarshipData?.scholarshipType == "OFFLINE" ? "Offline" : "Online"}
                                                        {scholarshipData?.scholarshipType == "ONLINE" && !scholarshipData?.offlineStartDate ? " : Ongoing – No Start or End Date Required" :
                                                            <span> :  {scholarshipData?.scholarshipType == "OFFLINE" ?
                                        ...
                                        <div className="card border-0 exm-time-box" >
                                            <div className='w-100 d-flex align-items-center gap-4 p-lg-5 p-3'>
                                                ...
                                                <div>
                                                    <h4>Exam Timings</h4>
                                                    <p> {scholarshipData?.scholarshipType == "OFFLINE" ? "Offline" : "Online"}
                                                        {scholarshipData?.scholarshipType == "ONLINE" && !scholarshipData?.offlineStartDate ? " : Flexible Timing – No Start or End Time"
                                                            : <span> : {scholarshipData?.scholarshipType == "OFFLINE" ?
                            ...
                            <div className="card share-frnd-card  border-0 exm-time-box">
                                <div className="row gy-4">
                                    <div className="col-md-8 mt-0 p-5 d-flex flex-column align-items-center align-items-md-start">
                                        ...
                                        <div className='  Syllabus-box d-flex align-items-center gap-2 border p-2 rounded-2' style={{ width: "fit-content", zIndex: "1000" }}
...
export default ScholarShipSlug