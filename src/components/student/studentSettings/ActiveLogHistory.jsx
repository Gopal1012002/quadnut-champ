...
import { StudentLogHistoryToggleService } from "../../../services/StudentServices";

const ActiveLogHistory = (props) => {
    ...
    const submitFormData = (e) => {
      setLoading(true)
      StudentLogHistoryToggleService(e).then((res)=>{
...
export default ActiveLogHistory;
