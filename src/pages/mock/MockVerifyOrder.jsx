...
import { VerifyMockOrderPhonepeService, VerifyOrderPhonepeService } from "../../services/StudentServices";
...
const VerifyMockOrder = () => {
  ...
  useEffect(() => {
    setLoading(true);
    VerifyMockOrderPhonepeService(id)
      .then((res) => {
                ...
                <div className="col-lg-4 col-md-6 col-sm-10 col-xs-12">
                  <div className="rounded">
                    <div className="card-body">
                      ...
                      {
                        slug ? 
                        <Link to={`/mock-details/${slug}`} className="btn btn-primary mt-3" >
                        Go to Mock Test
                      </Link> :
...
export default VerifyMockOrder;
